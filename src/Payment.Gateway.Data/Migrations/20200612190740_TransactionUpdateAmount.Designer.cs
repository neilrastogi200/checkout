...
namespace Payment.Gateway.Data.Migrations
{
    ...
    [Migration("20200612190740_TransactionUpdateAmount")]
    partial class TransactionUpdateAmount
    {
            ...
            modelBuilder.Entity("Payment.Gateway.Data.Entities.Merchant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MerchantId = new Guid("f5a96033-9694-4e71-a9f1-15e0e8b83a2e"),
                            IsActive = true,
                            Name = "Test Merchant 1"
                        },
                        new
                        {
                            MerchantId = new Guid("9892b287-ac96-4b2d-b94b-ff902ad4d3e4"),
                            IsActive = true,
