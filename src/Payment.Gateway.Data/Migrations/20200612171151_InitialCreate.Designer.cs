...
namespace Payment.Gateway.Data.Migrations
{
    ...
    [Migration("20200612171151_InitialCreate")]
            ...
            modelBuilder.Entity("Payment.Gateway.Data.Entities.Merchant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MerchantId = new Guid("7080d0ef-59a5-4088-915a-6bad7ac426fc"),
                            IsActive = true,
                            Name = "Test Merchant 1"
                        },
                        new
                        {
                            MerchantId = new Guid("8902770c-b8e6-4c5b-b6b5-69ed2cfb6938"),
                            IsActive = true,
