...
namespace Payment.Gateway.Data.Migrations
{
    ...
    [Migration("20200612190013_TransactionUpdate")]
            ...
            modelBuilder.Entity("Payment.Gateway.Data.Entities.Merchant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MerchantId = new Guid("1b436886-9eec-4fb2-a72d-62887b469295"),
                            IsActive = true,
                            Name = "Test Merchant 1"
                        },
                        new
                        {
                            MerchantId = new Guid("1d9a0bd1-6504-4761-81d3-34ff034350f9"),
                            IsActive = true,
